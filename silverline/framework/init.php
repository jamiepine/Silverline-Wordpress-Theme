...
// main-functions.php is loaded before anything else.
if ( file_exists( PARENT_THEME_DIR . '/main-functions.php' ) )
	include_once( PARENT_THEME_DIR . '/main-functions.php' );

if ( is_child_theme() && file_exists( CHILD_THEME_DIR . '/main-functions.php' ) )
	include_once( CHILD_THEME_DIR . '/main-functions.php' );
