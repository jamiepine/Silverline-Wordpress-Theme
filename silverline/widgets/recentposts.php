...
/**
  ...
  *
  */
class WP_widget_silverline_recent_posts extends WP_Widget {

    function WP_widget_silverline_recent_posts() {
        ...
        $this->WP_Widget('my-custom-recent-posts', __('SILVERLINE Recent Posts'), $widget_ops);
    ...
    function widget($args, $instance) {
        $cache = wp_cache_get('widget_silverline_recent_posts', 'widget');
...
register_widget('WP_widget_silverline_recent_posts');