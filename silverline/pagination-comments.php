 ...
 *
 * This function displays page navigation for comments in this theme.
 *
...
wpf_paginate_comments( array(
	...
	'prev_post_label' => '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', t() ) . '</span> ',
	'next_post_label' => '<span class="meta-nav">' . _x( '&rarr;', 'Next post link', t() ) . '</span>',
	'show_dots' => false,
