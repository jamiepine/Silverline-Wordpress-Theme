...
define( 'NOTIFIER_THEME_NAME', 'Silverline' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'silverline' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://www.pxlab.co.uk/UPDATES/silverlinenotifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
